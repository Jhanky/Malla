        ...
        var b = function (c, d) {
            (this.$element = a(c)),
                ...
                this.options.autohide &&
                    a(document).on("click", a.proxy(this.autohide, this)),
        ...
        (b.DEFAULTS = {
            ...
            (b.prototype.calcPlacement = function () {
                ...
                this.$element.hasClass("in") ||
                    this.$element
                        .css("visiblity", "hidden !important")
                        .addClass("in");
                var c = a(window).width() / this.$element.width(),
                    d = a(window).height() / this.$element.height(),
                    e = this.$element;
                (this.placement =
                    c >= d ? b("left", "right") : b("top", "bottom")),
                    "hidden !important" === this.$element.css("visibility") &&
            ...
            (b.prototype.slide = function (b, c, d) {
                ...
                b.each(function () {
                    "auto" !== a(this).css(f) &&
                        a(this).css(f, (parseInt(a(this).css(f), 10) || 0) + c),
                        "auto" !== a(this).css(g) &&
                            a(this).css(
                                g,
                                (parseInt(a(this).css(g), 10) || 0) - c
                            );
                }),
                    this.$element
                        .one(a.support.transition.end, d)
            ...
            (b.prototype.disableScrolling = function () {
                ...
                if (
                    (void 0 === a("body").data("offcanvas-style") &&
                        a("body").data(
                            "offcanvas-style",
                            a("body").attr("style") || ""
                        ),
                    ...
                    var d =
                        parseInt(a("body").css(c), 10) + a("body").width() - b;
                    setTimeout(function () {
                        a("body").css(c, d);
                    }, 1);
                }
                ...
                if (!this.state) {
                    ...
                    if ((this.$element.trigger(b), !b.isDefaultPrevented())) {
                        ...
                        var c = this.getCanvasElements(),
                            ...
                            e = this.opposite(d),
                            f = this.offset();
                        -1 !== c.index(this.$element) &&
                            (a(this.$element).data(
                                "offcanvas-style",
                                a(this.$element).attr("style") || ""
                            ),
                            this.$element.css(d, -1 * f),
                            this.$element.css(d)),
                            c.addClass("canvas-sliding").each(function () {
                                void 0 === a(this).data("offcanvas-style") &&
                                    a(this).data(
                                        "offcanvas-style",
                                        a(this).attr("style") || ""
                                    ),
                                    "static" === a(this).css("position") &&
            ...
            (b.prototype.toggle = function () {
                "slide-in" !== this.state &&
                    "slide-out" !== this.state &&
                    this["slid" === this.state ? "hide" : "show"]();
            }),
            (b.prototype.calcClone = function () {
                this.$calcClone = this.$element
                    .clone()
                    .html("")
            ...
            (b.prototype.recalc = function () {
                if (
                    "none" !== this.$calcClone.css("display") &&
                    ("slid" === this.state || "slide-in" === this.state)
                ) {
        ...
        (e.DEFAULTS = {
                ...
                (this.tests = []),
                    ...
                    a.each(
                        ...
                        a.proxy(function (a, d) {
                            "?" == d
                                ? (c--, (this.partialPosition = a))
                                : b[d]
                                ? (this.tests.push(new RegExp(b[d])),
            ...
            (e.prototype.listen = function () {
                if (!this.$element.attr("readonly")) {
                    ...
                    this.$element
                        .on("unmask.bs.inputmask", a.proxy(this.unmask, this))
                        .on(
                            "focus.bs.inputmask",
                            a.proxy(this.focusEvent, this)
                        )
                        .on("blur.bs.inputmask", a.proxy(this.blurEvent, this))
                        .on(
                            "keydown.bs.inputmask",
                            a.proxy(this.keydownEvent, this)
                        )
                        .on(
                            "keypress.bs.inputmask",
                            a.proxy(this.keypressEvent, this)
                        )
                        .on(b, a.proxy(this.pasteEvent, this));
                }
            }),
            ...
            (e.prototype.keypressEvent = function (a) {
                ...
                if (c) {
                    d.end - d.begin !== 0 &&
                        (this.clearBuffer(d.begin, d.end),
            ...
            (e.prototype.clearBuffer = function (a, b) {
                for (var c = this.mask.length, d = a; b > d && c > d; d++)
                    this.tests[d] &&
                        (this.buffer[d] = this.options.placeholder);
            }),
            ...
            (e.prototype.checkVal = function (a) {
                for (
                    ...
                    if (this.tests[e]) {
                        ...
                        this.buffer[e] == c.charAt(f) &&
                            e != this.partialPosition &&
                            (f++, (d = e));
                return (
                    !a && d + 1 < this.partialPosition
                        ? (this.$element.val(""), this.clearBuffer(0, b))
                        : (a || d + 1 >= this.partialPosition) &&
                          (this.writeBuffer(),
                          a ||
                              this.$element.val(
                                  this.$element.val().substring(0, d + 1)
                              )),
    ...
    +(function (a) {
            ...
            c = function (b, c) {
                if (
                    ...
                    (this.name = this.$input.attr("name") || c.name),
                        ...
                        (this.$preview =
                            this.$element.find(".fileinput-preview"));
        ...
        (c.prototype.listen = function () {
            this.$input.on("change.bs.fileinput", a.proxy(this.change, this)),
                a(this.$input[0].form).on(
                    "reset.bs.fileinput",
                    a.proxy(this.reset, this)
                ),
                this.$element
                    .find('[data-trigger="fileinput"]')
                    .on("click.bs.fileinput", a.proxy(this.trigger, this)),
                this.$element
                    .find('[data-dismiss="fileinput"]')
                    .on("click.bs.fileinput", a.proxy(this.clear, this));
        }),
            (c.prototype.change = function (b) {
                var c =
                    void 0 === b.target.files
                        ? b.target && b.target.value
                ...
                if (
                    ...
                    ("undefined" != typeof d.type
                        ? d.type.match(/^image\/(gif|png|jpeg)$/)
                        : d.name.match(/\.(gif|png|jpe?g)$/i)) &&
                    ...
                    (e.onload = function (b) {
                        ...
                        (e[0].src = b.target.result),
                            ...
                            "none" != f.css("max-height") &&
                                e.css(
                                    "max-height",
                                    parseInt(f.css("max-height"), 10) -
                                        parseInt(f.css("padding-top"), 10) -
                                        parseInt(f.css("padding-bottom"), 10) -
                                        parseInt(f.css("border-top"), 10) -
                                        parseInt(f.css("border-bottom"), 10)
                                ),
                            f.html(e),
                            g
