...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav fondo-contacta sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Calendario -->
            <li class="nav-item">
                <a class="nav-link" href="/Agente/Calendar">
                    <i class="fa-solid fa-calendar-days"></i>
                    <span>Calendario</span></a>
            </li>

            <!-- Nav Item - Horas trabajadas
            <li class="nav-item">
                <a class="nav-link" href="charts.html">
                    <i class="fa-solid fa-hourglass-end"></i>
                    <span>Horas trabajadas</span></a>
            </li>
 -->
            <!-- Divider -->
    ...
    <script src="{{ asset('fullcalendar/assets/js/material-dashboard.min.js?v=2.1.0') }}" type="text/javascript"></script>
